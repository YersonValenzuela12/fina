...
void Player(int x, int y){
  //cuerpo
  color_rgb(30, 132, 73);
  rectangulo_lleno(20+x,-5+y,40+x,20+y);
  //ala izq
  color_rgb(241, 196, 15);
  rectangulo_lleno(12+x,-5+y,20+x,20+y);
  color_rgb(133, 193, 233);
  rectangulo_lleno(-8+x,33+y,12+x,41+y);
    color_rgb(133, 193, 233);
  rectangulo_lleno(-18+x,-5+y,-8+x,41+y);
  //ala derecha
  color_rgb(241, 196, 15);
  rectangulo_lleno(40+x,-5+y,48+x,20+y);
  color_rgb(133, 193, 233);
  rectangulo_lleno(48+x,33+y,68+x,30+y);
    color_rgb(133, 193, 233);
  rectangulo_lleno(68+x,-5+y,78+x,30+y);
  //fondo
  color_rgb(133, 193, 233);
   rectangulo_lleno(x-15,20+y,68+x,30+y);
      color_rgb(133, 193, 233);
   rectangulo_lleno(x-15,-5+y,74+x,-20+y);
   //cabeza
  // color_rgb(133, 193, 233);
   //rectangulo_lleno(x-11,-5+y,-0+x,-50+y);
      color_rgb(133, 193, 233);
   rectangulo_lleno(x+11,-5+y,40+x,-50+y);
}
...
void PlayerHeart(int x, int y, int xx){
  ...
  //   void Presentation(600,400){
         //     color_rgb(200,20,20);
       //       linea(0,0,600,400); 
     //     rectangulo_lleno(xm+200,ym+100,xm+390,ym+300);       
   //       }
...
int main(){
    ...
    std::string TUText = "Hola :";
    std::string TUUText = "TU PUEDES";
    std::string TUUUText = "MUY BIEN";  
    std::string TUUUUText = "EXCELENTE";
    ...
    while(t != ESCAPE){
        ...
        // Colision Detection 
          ...
          // Enemy on Row 2 Bullets to the Player
              ...
              number=1;
              texto(315, 457, TUUText);
              
                    }else if(CurrentScoreNumber < 700){
            texto(315, 457, TUUUText);    
                             }else if(CurrentScoreNumber < 1200){
                                 number=3; 
           texto(315, 457, TUUUUText);
                                  }
